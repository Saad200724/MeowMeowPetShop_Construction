      ...
      <div className="bg-[#38603d] text-white py-2 text-sm overflow-hidden relative">
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-2">
            ...
            <div className="flex-1 flex justify-center items-center relative overflow-hidden mx-4 min-h-[24px]">
              {currentAnnouncement && (
                <div className="w-full h-full relative">
                  <div className="animate-marquee whitespace-nowrap absolute top-0 left-full h-full flex items-center" style={{ width: 'max-content' }}>
