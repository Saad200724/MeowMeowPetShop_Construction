  ...
  return (
    <section className="section-spacing bg-white">
      <div className="responsive-container">
        {/* Header */}
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-center text-[#26732d] flex items-center justify-center gap-3 animate-fade-in">
            <ShoppingBag size={24} className="text-[#26732d]" />
            SHOP BY CATEGORY
          </h2>
        </div>
        ...
        <div className="grid grid-cols-3 gap-6 md:hidden px-4">
          {categories.slice(0, 9).map((category, index) => {
            ...
            return (
              ...
              >
                <div className="bg-white rounded-2xl shadow-2xl overflow-hidden h-48 flex flex-col">
                  <div className="relative overflow-hidden bg-gray-50 p-6 flex-1 flex items-center justify-center">
                    <img
                      src={category.image}
                      alt={category.name}
                      className="w-full h-full object-contain transition-transform duration-500 group-hover:scale-110 max-h-24"
                      loading="lazy"
                      decoding="async"
                    />
