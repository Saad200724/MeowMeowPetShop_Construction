...
export default function HeroBanner() {
  return (
    <section className="relative bg-white py-4">
      {/* Banner Container with exact 1200x400px dimensions */}
      <div className="container mx-auto px-4">
        <div className="relative w-full max-w-[1200px] mx-auto">
          <div className="relative w-[1200px] h-[400px] mx-auto overflow-hidden rounded-xl">
            <img
              src="/Banner_Reflex.png"
              alt="Reflex High Quality - আর্ডার করলেই পেয়ে যাচ্ছেন আকর্ষণীয় GIFT - Shop Now"
              className="w-[1200px] h-[400px] object-cover rounded-xl"
              loading="eager"
