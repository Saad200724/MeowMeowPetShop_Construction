...
export default function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 relative overflow-hidden group border border-gray-100 h-[380px] md:h-[360px] sm:h-[340px] flex flex-col w-[200px] max-w-[250px]">
      {/* Discount Badge */}
      {product.discount && (
      ...
      <div className="relative overflow-hidden bg-white rounded-t-2xl h-44 md:h-40 sm:h-36 flex items-center justify-center flex-shrink-0">
        <img 
          src={product.image} 
          alt={product.name} 
