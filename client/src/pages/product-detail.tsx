...
import { Heart, ShoppingCart, Star, Minus, Plus, Share, Facebook, Twitter, Instagram, Copy, Send, Truck, MapPin, CheckCircle, Clock, ChevronDown } from 'lucide-react';
                ...
                <div className="space-y-6">
                  {product.description && (
                    <div>
                      ...
                      <div 
                        className="text-gray-700 prose prose-sm max-w-none dark:prose-invert"
