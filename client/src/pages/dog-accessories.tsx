...
export default function DogAccessoriesPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Section */}
      <section className="pt-24 pb-4 md:pb-8 px-4 bg-gradient-to-r from-amber-500 to-orange-500 text-white">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold mb-2 md:mb-4">Dog Health & Accessories</h1>
          <p className="text-sm md:text-xl opacity-90 mb-4 md:mb-6">Everything your dog needs for health and happiness</p>
      ...
      <section className="py-8 px-4">
        <div className="max-w-7xl mx-auto lg:flex lg:gap-1">
          ...
          <main className="lg:w-3/4">
            {/* Analytics Bar */}
            <AnalyticsBar categoryId="dog-accessories" />

            {/* Products Grid */}
            <div className="mt-6">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-2xl font-bold text-gray-900">Dog Health & Accessories</h2>
