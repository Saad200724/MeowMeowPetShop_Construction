...
export default function DogAccessoriesPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Section */}
      <section className="pt-24 pb-8 px-4 bg-gradient-to-r from-amber-500 to-orange-500 text-white">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Dog Health & Accessories</h1>
          <p className="text-xl opacity-90 mb-6">Everything your dog needs for health and happiness</p>
