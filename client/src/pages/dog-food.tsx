...
export default function DogFoodPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Section */}
      <section className="pt-6 pb-6 px-4 md:pt-8 md:pb-8 lg:pt-10 lg:pb-10 md:px-8 bg-gradient-to-r from-blue-500 to-purple-500 text-white">
        ...
        <div className="max-w-7xl mx-auto lg:flex lg:gap-6 xl:gap-8">
          ...
          <main className="lg:w-3/4 space-y-4 md:space-y-6">
            ...
            <div className="flex flex-wrap gap-2 justify-between items-center">
              ...
              <div className="bg-blue-100 text-blue-800 px-2.5 sm:px-3 py-1 rounded-full text-xs md:text-sm font-medium whitespace-nowrap">
