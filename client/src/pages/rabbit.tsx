    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="pt-24 pb-8 px-4 bg-gradient-to-r from-pink-500 to-rose-500 text-white">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Rabbit Food & Accessories</h1>
          <p className="text-xl opacity-90 mb-6">Complete care for your fluffy bunny friends</p>
