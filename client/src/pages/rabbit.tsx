...
export default function RabbitPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Section */}
      <section className="pt-16 pb-2 md:pb-8 px-4 bg-gradient-to-r from-pink-500 to-rose-500 text-white">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-lg md:text-4xl lg:text-5xl font-bold mb-1 md:mb-4">Rabbit Food & Accessories</h1>
          <p className="text-xs md:text-xl opacity-90 mb-2 md:mb-6">Complete care for your fluffy bunny friends</p>
