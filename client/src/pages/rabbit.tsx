...
export default function RabbitPage() {
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="flex items-center justify-center pt-32">
          <div className="text-center">
            ...
            <p className="text-gray-600">Loading rabbit products...</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Section */}
      <section className="pt-6 pb-6 px-4 md:pt-8 md:pb-8 lg:pt-10 lg:pb-10 md:px-8 bg-gradient-to-r from-pink-500 to-rose-500 text-white">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-sm sm:text-base md:text-lg mb-4 md:mb-6 text-white opacity-95">
            Complete care for your fluffy bunny friends
          </p>
          ...
          <div className="relative w-full max-w-md">
            ...
            <Input
              placeholder="Search rabbit products..."
              className="h-10 sm:h-11 rounded-full pl-11 pr-4 text-sm bg-white text-gray-900 shadow-md border-0 focus:ring-2 focus:ring-rose-400 placeholder:text-gray-500"
              value={searchQuery}
              onChange={(e) => handleSearch(e.target.value)}
              data-testid="input-search-rabbit"
            />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto lg:flex lg:gap-6 xl:gap-8">
          ...
          <main className="lg:w-3/4 space-y-4 md:space-y-6">
            ...
            <div className="flex flex-wrap gap-2 justify-between items-center">
              ...
              <div className="bg-rose-100 text-rose-800 px-2.5 sm:px-3 py-1 rounded-full text-xs md:text-sm font-medium whitespace-nowrap">
