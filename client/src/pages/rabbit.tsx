...
export default function RabbitPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Section */}
      <section className="pt-24 pb-4 md:pb-8 px-4 bg-gradient-to-r from-pink-500 to-rose-500 text-white">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold mb-2 md:mb-4">Rabbit Food & Accessories</h1>
          <p className="text-sm md:text-xl opacity-90 mb-4 md:mb-6">Complete care for your fluffy bunny friends</p>
          ...
          <main className="lg:w-3/4">
            ...
            <div className="mt-6">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-2xl font-bold text-gray-900">Rabbit Food & Accessories</h2>
